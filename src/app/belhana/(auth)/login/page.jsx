    ...
    <section className="container h-screen bg-white flex items-start justify-center py-8 px-4">
      ...
      <div className=" py-8 px-6 border rounded-md border-gray-300 h-auto w-full space-y-4 md:w-[600px]  ">
        ...
        <p className="text-gray-500 text-sm leading-relaxed">
          ...
          you liked.If you do not have an account yet, you{" "}
          <Link
            href="/belhana/register"
        ...
        <form action="" className="space-y-8">
          ...
          <div className="flex items-center justify-between">
            <div className="flex  items-center gap-2  ">
              <Checkbox
                id="rememberMe"
                className="h-4 w-4 ring ring-gray-600 focus:outline-none border-gray-700"
              />
          ...
          <div className="space-y-4">
            ...
            <span className="text-sm text-dark-gray text-center inline-block w-full font-semibold">
              Or
            </span>
            {/* google button */}
